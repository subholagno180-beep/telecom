...
with tabs[0]:
    decision = st.radio("Issue and Solution from Remediation and Root Cause agent", ["Approve", "Reject"], horizontal=True)
...
with tabs[1]:
    st.write('Output of the action performed based on human approval')
