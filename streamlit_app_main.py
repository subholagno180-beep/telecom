...
pages = [
    ...
    st.Page(page = PAGE_3_PATH, title = 'Remediation Dashboard'),
    st.Page(page = PAGE_4_PATH, title = 'Auto Resolution Dashboard'),
    st.Page(page = PAGE_5_PATH, title = 'Ticket Management Dashboard')
]
